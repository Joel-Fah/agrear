...
<head>
    ...
    <title>Agrear &middot; Login</title>
                ...
                <div class="register-form">
                    ...
                    <?php include('errors.php'); ?>
                        <div class="input-field">
                            ...
                            <input type="text" name="username" class="form-input" placeholder="Enter your email">
                        </div>
                        <div class="input-field">
                            <label for="">Password</label> <br>
                            <input type="password" name="password" class="form-input" placeholder="Enter your password">
                        </div>
                        <input type="submit" value="Sign In" name="login_user" class="form-btn" style="margin-top: 25%;">
                    </form>
                </div>
